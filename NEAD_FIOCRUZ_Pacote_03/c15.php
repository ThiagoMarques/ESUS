...
<body>
    ...
    <html>
    <!-- Exercício Selecionar estabelecimento -->
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c14');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c16');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "A funcionalidade “Selecionar Estabelecimento” está disponível somente para usuários com perfil do tipo “Gestor”.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. Somente perfis do tipo “Gestor” podem acessar a funcionalidade “Selecionar Estabelecimento”.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Algumas funcionalidades, como “Entrada” e “Dispensação”, necessitam de vínculo com um estabelecimento de saúde para seu acesso.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. Essas funcionalidades, além de outras do módulo “Movimentação e Logística” exigem a vinculação do operador do Sistema a um estabelecimento de saúde.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "É possível se vincular a um estabelecimento de saúde de esfera distinta do seu perfil de acesso no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. Somente estarão disponíveis para seleção estabelecimentos de saúde da mesma esfera do perfil do usuário logado.',
            feedback2: 'Muito bem!',
          }
        ]
    ...
    const moduleExercise = 'M1E5'
    const currentExercise = 'c15.php'
    const nextWindow = 'c16.php'
