...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c10');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c12');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "O cadastro de produtos pode ser realizado por usuários com qualquer perfil no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Errado. Somente usuários com perfil do tipo “Gestor Master” (atribuído a técnicos do Ministério da Saúde) podem realizar o cadastro de produtos no e-SUS AF.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Os produtos no e-SUS AF são divididos em duas grandes classes: medicamentos e produtos para saúde.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. Essa divisão está inclusive mostrada em abas distintas na funcionalidade de “Consulta de Produto”.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Entre várias outras informações, o código de barras está presente no cadastro de produto.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Sim. O código de barras consta no cadastro de produto no e-SUS AF.',
            feedback2: 'Item incorreto.',
          }
        ]
    ...
    const moduleExercise = 'M1E3'
    const currentExercise = 'c11.php'
    const nextWindow = 'c12.php'
