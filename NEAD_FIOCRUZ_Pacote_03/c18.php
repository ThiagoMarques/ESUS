...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c17');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c19');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "O cadastro de usuário SUS é imprescindível para a realização de um registro de dispensação no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. Para se realizar uma dispensação, é necessário o vínculo de um usuário SUS ao registro.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O usuário SUS precisa ser cadastrado em cada estado e município no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. O cadastro de usuário SUS é nacional. Assim, uma vez cadastrado no e-SUS AF, o registro não precisa ser realizado novamente.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Os dados do usuário SUS, importados do Sistema CADSUS, podem ser alterados no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. Os dados importados do CADSUS não estão disponíveis para edição no e-SUS AF. Somente poderão ser alterados no próprio CADSUS.',
            feedback2: 'Muito bem!',
          }
        ]
    ...
    const moduleExercise = 'M2E1'
    const currentExercise = 'c18.php'
    const nextWindow = 'c19.php'
