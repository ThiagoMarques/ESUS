...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c19');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c21');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "O e-SUS AF permite o cadastro dispensações com vários agendamentos para o mesmo usuário SUS.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. Tais dispensações possuem a situação “Agendada”.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O campo CID-10 é obrigatório para qualquer registro de dispensação.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. O campo CID-10 será obrigatório somente para dispensações com o produto “Talidomida” ou derivados.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Na tela “Incluir Dispensação”, ao acionar o botão “Dispensar Todos Automaticamente”, são atendidos todos os produtos em tela utilizando os lotes em estoque com menor prazo de validade.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. Ao acionar o botão “Dispensar Todos Automaticamente”, são atendidos todos os produtos em tela utilizando os lotes em estoque com menor prazo de validade.',
            feedback2: 'Item incorreto.',
          }
        ]
    ...
    const moduleExercise = 'M2E2'
    const currentExercise = 'c20.php'
    const nextWindow = 'c21.php'
