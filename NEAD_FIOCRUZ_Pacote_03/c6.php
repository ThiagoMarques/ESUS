...
<body>
  ...
  <body>
      ...
      <div class="row">
        ...
        <div id="video_principal" class="col-lg-8 text-left">
          <div class="video text-center">
            <div class="row">
              <div class="col-lg-11">
                <span class="video_title">Cadastro de estabelecimento</span>
              </div>
              <div class="col-lg-1">
            ...
            <video id="custom_video_play" controls="controls">
              <source src="https://efg.brasilia.fiocruz.br/ava/external/ESUS_Recursos/videos/Cadastro_Estabelecimento.mp4"
                type="video/mp4">
    ...
    <div class="stepBack" onclick="stepNavigationNew('c5');"><i class="fas fa-chevron-left"></i></div>
    <div class="stepFoward" onclick="stepNavigationNew('c7');"><i class="fas fa-chevron-right"></i></div>
