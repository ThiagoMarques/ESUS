...
<body>
    ...
    <html>
    <!-- Exercício Configurações (Subgrupo de origem) -->
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c8');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c10');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "Os subgrupos de origem são obrigatórios para o uso na funcionalidade “Dispensação” do e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. Os subgrupos de origem são atributos de preenchimento obrigatório durante o registro de uma dispensação no e-SUS AF.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O subgrupo de origem de receita se refere ao tipo e cor do receituário utilizado para uma dispensação.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. O subgrupo de origem de receita se refere ao estabelecimento de saúde que emitiu a receita médica.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Usuários com qualquer tipo de perfil podem realizar cadastros de subgrupos de origem de receita.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não é verdade. O cadastro de subgrupo de origem de receita é restrito a perfis do tipo gestor.',
            feedback2: 'Muito bem!',
          }
        ]
    ...
    const moduleExercise = 'M1E2'
    const currentExercise = 'c9.php'
    const nextWindow = 'c10.php'
