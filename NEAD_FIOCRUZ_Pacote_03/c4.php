...
<body>
    ...
    <html>
    <!-- Exercício Solicitação de perfil -->
    <div class="container">
        ...
        <div id="resultado" class="row">
            <div class="col-lg-12 text-left align-self-center resultado">
                ...
                <input type="button" onclick="changeWindow()" value="Responder avaliação">
                <h1></h1>
            </div>
            <div class="stepBack" onclick="stepNavigationNew('c3');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c5');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "O e-mail não é um dado necessário para a solicitação de perfil no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'O e-mail é um dado necessário tanto para o acesso ao SCPA, quanto ao e-SUS AF. Dessa maneira, trata-se de informação imprescindível para a solicitação de perfil no e-SUS AF.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Vários perfis de acesso podem ser vinculados ao mesmo usuário no SCPA. Em qualquer situação, a autorização do acesso não é necessária.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'É verdade que um mesmo usuário (mesma senha) possa ter vários perfis de acesso ao e-SUS AF. Entretanto, a autorização de perfil pelo gestor da esfera correspondente é sempre necessária',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O simples cadastro do usuário ao SCPA (Sistema de Cadastro e Permissão de Acesso) não dá acesso automático ao e-SUS AF. Isto é, a solicitação de perfil ao e-SUS AF é passo posterior e obrigatório à solicitação de acesso ao SCPA.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. As solicitações de acesso ao SCPA e de perfil ao e-SUS AF são etapas separadas e obrigatórias a fim de se ter acesso ao e-SUS AF.',
    ...
    const moduleExercise = 'M0E2'
    const currentExercise = 'c4.php'
    const nextWindow = 'c5.php'
