...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c12');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c14');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "O cadastro de empenho é obrigatório para a realização de entradas no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Errado. Para realizar entradas no e-SUS AF, o cadastro de empenho não é necessário.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O cadastro de empenho é uma importante ferramenta de gestão, demonstrando transparência na aplicação e controle de recursos financeiros.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. O cadastro de empenho funciona como uma importante ferramenta de gestão e controle de recursos financeiros.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Um empenho com a situação “Finalizado” poderá ser reaberto, caso necessário.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. Somente empenhos com a situação “Encerrado” podem ser reabertos. Empenhos com a situação “Finalizado” não alteram sua situação, pois todos seus produtos foram recebidos.',
            feedback2: 'Muito bem!',
          }
        ]
    ...
    const moduleExercise = 'M1E4'
    const currentExercise = 'c13.php'
    const nextWindow = 'c14.php'
