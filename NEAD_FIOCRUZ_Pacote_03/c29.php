...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c28');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c30');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "Produtos com validade vencida são retirados do estoque por meio da funcionalidade “Saídas Diversas”.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. A funcionalidade “Saídas Diversas” é utilizada para retirar produtos vencidos do estoque',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Saídas diversas com a situação “Em preenchimento” foram concluídas e os respectivos produtos foram retirados do estoque do estabelecimento.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. A situação “Em preenchimento” se trata de um registro não concluído. Assim, os produtos referentes ao registro não foram retirados do estoque do estabelecimento.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O campo “Justificativa” é de preenchimento obrigatório na tela “Incluir Saída Diversa”.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. Não é possível concluir um registro de saída diversa sem informar uma justificativa.',
            feedback2: 'Item incorreto.',
          }
        ]
    ...
    const moduleExercise = 'M3E4'
    const currentExercise = 'c29.php'
    const nextWindow = 'c30.php'
