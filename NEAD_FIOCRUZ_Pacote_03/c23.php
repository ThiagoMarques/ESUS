...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c22');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c24');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "Um registro de entrada com situação “Armazenada” tem os seus produtos armazenados no estoque de um estabelecimento de saúde.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Exatamente. Entradas armazenadas têm seus produtos disponíveis em estoque',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Registros de empenho podem ser resgatados na funcionalidade de entrada, mas sua vinculação não é obrigatória.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. Empenhos previamente cadastrados podem ser utilizados em entradas, mas não são obrigatórios.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O campo “Condições Especiais de Armazenamento” é de preenchimento obrigatório para a conclusão do registro de entrada.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. O campo “Condições Especiais de Armazenamento” não é de preenchimento obrigatório para a conclusão do registro de entrada.',
            feedback2: 'Muito bem!',
          }
        ]
    ...
    const moduleExercise = 'M3E1'
    const currentExercise = 'c23.php'
    const nextWindow = 'c24.php'
