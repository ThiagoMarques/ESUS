...
<body>
    ...
    <html>
    <!-- Exercício Cadastro de estabelecimento -->
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c6');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c8');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "Todos os estabelecimentos que possuem CNES (Cadastro Nacional de Estabelecimentos de Saúde) já se encontram cadastrados no e-SUS AF.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. O gestor precisa efetuar o cadastro dos estabelecimentos de saúde de sua respectiva esfera de atuação.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "Obrigatoriamente, cada estabelecimento de saúde no e-SUS AF precisa ter ao menos um farmacêutico cadastrado.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'A vinculação de farmacêutico ao cadastro de estabelecimento de saúde não é obrigatória no e-SUS AF.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O cadastro de endereçamentos físicos em um estabelecimento de saúde no e-SUS AF é uma forma de organizar o estoque virtual à maneira do estoque físico da unidade, permitindo assim a rápida conferência e localização de produtos..",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. O cadastro de endereçamentos físicos é uma importante ferramenta de organização de estoques no e-SUS AF',
    ...
    const moduleExercise = 'M1E1'
    const currentExercise = 'c7.php'
    const nextWindow = 'c8.php'
