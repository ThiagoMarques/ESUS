...
<body>
    ...
    <div class="container">
        ...
        <div id="resultado" class="row">
            ...
            <div class="stepBack" onclick="stepNavigationNew('c24');"><i class="fas fa-chevron-left"></i></div>
            <div class="stepFoward" onclick="stepNavigationNew('c26');"><i class="fas fa-chevron-right"></i></div>
        </div>
    </div>
...
<script>
    ...
    let questions = [
          {
            ...
            question: "Lotes bloqueados em estoque não podem ser distribuídos, mas podem ser dispensados.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 2,
            feedback1: 'Não. Lotes bloqueados não podem sofrer qualquer tipo de movimentação no e-SUS.',
            feedback2: 'Muito bem!',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O e-SUS AF permite o bloqueio de lotes que ainda não constam em estoque.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. A opção “Outros Lotes”, na tela “Cadastrar Bloqueio de Lote” permite o bloqueio de lotes ainda não inseridos em estoque.',
            feedback2: 'Item incorreto.',
          },
          {
            type: 'VF',
            enunciate: 'Julgue a afirmativa abaixo:',
            question: "O e-SUS AF permite desativar um bloqueio de lotes. Isto é, desbloquear lotes previamente bloqueados em estoque.",
            choice1: "Verdadeiro",
            choice2: "Falso",
            answer: 1,
            feedback1: 'Isso mesmo. Ao acionar o botão “Desativar” em um registro de bloqueio de lote, o registro se torna inativo e os lotes do registro são desbloqueados no Sistema.',
            feedback2: 'Item incorreto.',
          }
        ]
    ...
    const moduleExercise = 'M3E2'
    const currentExercise = 'c25.php'
    const nextWindow = 'c26.php'
